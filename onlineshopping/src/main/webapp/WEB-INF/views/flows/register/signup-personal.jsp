...
<%@include file="../register/shared/flows-header.jsp"%>
				...
				<div class="panel panel-body">
					...
					<sf:form method="POST" class="form-horizontal" id="registerForm" modelAttribute="user">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<label class="radio-inline"> <sf:radiobutton path="role"
										...
										path="role" value="SUPPLIER" checked="checked" />Supplier
								</label>
							</div>
						...
						<div class="col-md-offset-4 col-md-8">
							...
							<button type="submit" class="btn btn-primary" name="${flowExecutor}_eventId_billing">
...
<%@include file="../register/shared/flows-footer.jsp"%>